...
void CFonts::Reload(float flDPI, bool bOutline)
{
	...
	m_mFonts[FONT_ESP] = { "Verdana", int(12.f * flDPI), iFlags, 0, m_mFonts[FONT_ESP].m_dwFont };
	m_mFonts[FONT_INDICATORS] = { "Verdana", int(13.f * flDPI), iFlags, 0, m_mFonts[FONT_INDICATORS].m_dwFont };
