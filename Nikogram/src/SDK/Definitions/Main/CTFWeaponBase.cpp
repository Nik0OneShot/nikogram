...
#define ReturnTexture(string) { static CHudTexture* pTexture = nullptr; if (!pTexture) pTexture = H::Draw.GetIcon(string); return pTexture; } // retry until the icon exists
